...
public class NamespaceOperationService {
    ...
    public NamespaceOperationService(
            ConfigInfoPersistService configInfoPersistService, CommonPersistService commonPersistService) {
    ...
    public List<Namespace> getNamespaceList() {
        ...
        Namespace namespace0 = new Namespace(
                ...
                DEFAULT_NAMESPACE,
                DEFAULT_QUOTA,
                configInfoPersistService.configInfoCount(DEFAULT_TENANT),
        ...
        for (TenantInfo tenantInfo : tenantInfos) {
            ...
            Namespace namespaceTmp = new Namespace(
    ...
    public Boolean createNamespace(String namespaceId, String namespaceName, String namespaceDesc)
        ...
        commonPersistService.insertTenantInfoAtomic(
                DEFAULT_KP,
                namespaceId,
                namespaceName,
                namespaceDesc,
