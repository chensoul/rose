...
public class ExcelHelper {
    ...
    public static void writeExcel(
        ...
        CustomSheetWriteHandler customSheetWriteHandler =
                new CustomSheetWriteHandler(explicitListConstraintMap, data.size());
    ...
    public static void writeExcel(
        ...
        try {
            ...
            ExcelWriterBuilder excelWriterBuilder =
                    EasyExcel.write(response.getOutputStream(), head).registerConverter(localDateTimeConverter);
    ...
    public static File writeExcelToFile(
            String fileName,
            String sheetName,
            Class<?> clazz,
            Collection<?> data,
    ...
    public static File writeExcelToFile(
        ...
        try {
            ...
            @Cleanup OutputStream outputStream = new FileOutputStream(tempFile);

            ExcelWriterBuilder excelWriterBuilder =
                    EasyExcel.write(outputStream, clazz).registerConverter(localDateTimeConverter);
    ...
    @SneakyThrows
    public static File importAndSaveFail(
    ...
    @SneakyThrows
    public static File mergeImportAndSaveFail(
            InputStream inputStream,
            String filename,
            String sheetName,
            Integer headRowNumber,
            Class<?> clazz,
            ReadMergeValidateListener readValidateListener,
            MergeByPrimaryKeyStrategy mergeByPrimaryKeyStrategy) {
        return mergeImportAndSaveFail(
                inputStream,
                sheetName,
                filename,
                0,
    ...
    public static File mergeImportAndSaveFail(
        ...
        return writeExcelToFile(
                filename, sheetName, clazz, readValidateListener.getFailData(), mergeByPrimaryKeyStrategy);
    }
}
