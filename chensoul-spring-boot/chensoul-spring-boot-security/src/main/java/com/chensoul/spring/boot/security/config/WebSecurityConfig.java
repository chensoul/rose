...
//    OAuth2Configuration oauth2Configuration;
	...
	protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity
			.authorizeHttpRequests(c -> c
				...
				.requestMatchers(DEFAULT_PATH_TO_SKIP).permitAll()
				.requestMatchers(permitUrls.toArray(new String[0])).permitAll()
				.requestMatchers(securityProperties.getPathsToSkip().toArray(new String[0])).permitAll()
				.requestMatchers(securityProperties.getBaseUrl()).authenticated()
			);
	...
	protected RestAccessProcessingFilter restAccessTokenProcessingFilter() throws Exception {
		SkipPathRequestMatcher matcher = new SkipPathRequestMatcher(securityProperties.getPathsToSkip(), securityProperties.getBaseUrl());
