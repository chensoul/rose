...
public class MybatisTenantConfiguration {
	...
	@Bean
	public TenantLineInnerInterceptor tenantLineInnerInterceptor(MybatisPlusInterceptor interceptor, TenantProperties tenantProperties) {
		DefaultTenantLineHandler defaultTenantLineHandler = new DefaultTenantLineHandler(tenantProperties.getIgnoredTables());
