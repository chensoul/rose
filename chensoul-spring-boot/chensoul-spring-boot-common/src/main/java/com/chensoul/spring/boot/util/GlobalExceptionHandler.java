//package com.chensoul.boot.mvc.handler;
//
//import com.chensoul.support.exception.BusinessException;
//import com.chensoul.support.exception.NotFoundException;
//import com.chensoul.support.exception.ResultCode;
//import com.chensoul.support.exception.TooManyRequestException;
//import com.chensoul.support.util.ErrorResponse;
...
//
//import static com.chensoul.support.exception.ResultCode.INTERNAL_ERROR;
//
/// **
...
//			return handleSQLIntegrityConstraintViolationException((ConstraintViolationException) ex);
//		}
...
//		}
//
//		return ErrorResponse.of(ResultCode.BAD_REQUEST.getCode(), String.format("数据库异常: %s", message));
//	}
//
//	/**
...
//		logException(ex, request);
//		return ErrorResponse.of(ResultCode.FORBIDDEN.getCode(), ResultCode.FORBIDDEN.getName());
//	}
//
