...
import com.chensoul.spring.boot.springdoc.pig.annotation.EnableSpringDoc;
...
public class OpenAPIDefinitionImportSelector implements ImportBeanDefinitionRegistrar {
	...
	public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
		Map<String, Object> annotationAttributes = metadata.getAnnotationAttributes(EnableSpringDoc.class.getName(), true);
